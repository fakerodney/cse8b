...
public class FunWithIntArrays 
{
   ...
   */
  public static int findRange(final int array[]) {
   ...
   */
  public static double findAvg(final int array[]) {
    // short circuit protects null access
    if (array == null || array.length == 0) {
      return 0;
    }
    ...
    final double average = (Double.valueOf(sum) / (array.length));
   ...
   * @return none.
   */
  public static void arraySort(final int[] array) {
    if (array == null) {
      return;
    }
